!function() {
    ...
    function bt(n, t, e) {
        ...
        return (i = Ga.get(n)) ? t(i.r, i.g, i.b) : (null == n || "#" !== n.charAt(0) || isNaN(i = parseInt(n.slice(1), 16)) || (4 === n.length ? (o = (3840 & i) >> 4,
        o = o >> 4 | o,
        a = 240 & i,
        a = a >> 4 | a,
        c = 15 & i,
    ...
    ta.behavior.zoom = function() {
        ...
        function g() {
            ...
            y ? clearTimeout(y) : (Dl.call(this),
            v = e(d = m || ta.mouse(this)),
            c(n)),
